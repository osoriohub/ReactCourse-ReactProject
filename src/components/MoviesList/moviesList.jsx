...
import MovieDetails from '../MoviesDetail/MovieDetail'
        ...
        this.state = {
            movies: [
                ...
                },
                {
                    ...
                    img: 'https://www.tonica.la/__export/1592926678894/sites/debate/img/2020/06/23/confirman-secuela-de-pollitos-en-fuga.jpg_554688468.jpg',
                    description: 'Pollos de plastilina que intentan huir',
                    characters: [
                        {
                            name: 'Gudi',
                            img: 'https://vignette.wikia.nocookie.net/toystory/images/0/05/Profile_-_Woody.jpg/revision/latest?cb=20200928032134&path-prefix=es',
